  ...
  return (
    <div
      ...
      className={`relative flex flex-col items-center justify-center rounded-xl border-b-[6px] shadow-lg transition-all transform w-full p-3 
        ...
        ${isSelected && !isOffice ? 'ring-4 ring-offset-2 ring-indigo-400' : ''}
        ${styles}
            ...
            <div className="flex justify-center items-center w-full">
                {topRoom && (
                   <RoomCard 
                       ...
                       viewMode={viewMode}
                       isSelected={selectedRoom?.id === topRoom.id}
                    />
                )}
            </div>

            {/* Main floor layout with wings */}
            ...
            <div className="flex justify-center items-center w-full">
                {bottomRoom && (
                   <RoomCard 
                       ...
                       viewMode={viewMode}
                       isSelected={selectedRoom?.id === bottomRoom.id}
                    />
                )}
            </div>
        </div>
